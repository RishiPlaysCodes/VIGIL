"""
Django settings for Vigil Backend.
"""
import os
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'vigil-dev-secret-key-change-in-production')
...
SMS_PROVIDER = os.environ.get('SMS_PROVIDER', 'msg91')  # 'msg91' or 'twilio'
